...
function detectEmotion(text) {
    ...
    if (
        t.includes('anxious') || t.includes('nervous') || t.includes('worried') ||
        t.includes('panic') || t.includes('fear') || t.includes('scared')
    ) return 'anxiety';

    if (
        t.includes('stressed') || t.includes('overwhelmed') || t.includes('pressure') ||
        t.includes('burnt out') || t.includes('tired') || t.includes('sad')
    ) return 'stress';
